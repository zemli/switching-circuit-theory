...
#define yyparse blif_yyparse
#define yylex   blif_yylex
#define yyerror blif_yyerror
#define yylval  blif_yylval
#define yychar  blif_yychar
#define yydebug blif_yydebug
#define yynerrs blif_yynerrs
...
{
       0,     0,     3,     5,     7,    10,    16,    19,    20,    22,
      23,    26,    27,    30,    33,    35,    36,    39,    42,    43,
      45,    48,    51,    53,    55,    58,    62
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      16,    18,    19,    20,    17,    -1,     3,    10,    -1,    -1,
       7,    -1,    -1,     5,    25,    -1,    -1,     6,    25,    -1,
      20,    21,    -1,    21,    -1,    -1,    22,    23,    -1,     4,
      25,    -1,    -1,    24,    -1,    23,    24,    -1,     8,     9,
      -1,     9,    -1,    26,    -1,    25,    26,    -1,    25,    11,
      26,    -1,    10,    -1
};
...
{
       0,    61,    61,    64,    65,    68,    79,    85,    86,    89,
      90,   112,   113,   137,   148,   162,   167,   227,   306,   309,
     313,   334,   378,   403,   418,   430,   444
};
#endif
...
{
  "$end", "error", "$undefined", "TOKEN_MODEL", "TOKEN_NAMES",
  "TOKEN_INPUT", "TOKEN_OUTPUT", "TOKEN_END", "TOKEN_CUBE_STRING",
  "TOKEN_CUBE_VALUE", "TOKEN_STRING", "TOKEN_LINE_BREAK", "$accept",
  "blif_circuit", "models", "model", "header", "footer",
  "input_declaration", "output_declaration", "function_list",
  "single_function", "function_declaration", "cube_statements",
  "cube_statement", "signal_list", "signal", 0
};
#endif
...
{
       0,     0,     0,     2,     3,     9,     6,     1,     4,     0,
      11,    26,    10,    23,     0,    15,     0,    24,    12,     0,
       7,    14,    18,    25,    17,     8,     5,    13,     0,    22,
      16,    19,    21,    20
};
...
{
       4,    -9,    11,     4,   -13,    10,   -13,   -13,   -13,     6,
      12,   -13,    -1,   -13,     6,    13,     6,   -13,    -1,     6,
      -2,   -13,     5,   -13,    -1,   -13,   -13,   -13,    14,   -13,
       5,   -13,   -13,   -13
};
...
{
      17,     6,    19,    18,    23,    25,    17,     1,    24,    11,
      16,     7,    17,    28,    29,     9,    11,    19,    14,     8,
      27,     0,    33,    32
};

static const yytype_int8 yycheck[] =
{
      12,    10,     4,    14,    16,     7,    18,     3,    19,    10,
      11,     0,    24,     8,     9,     5,    10,     4,     6,     3,
      20,    -1,    30,     9
};
...
{
       0,     3,    13,    14,    15,    16,    10,     0,    15,     5,
      18,    10,    25,    26,     6,    19,    11,    26,    25,     4,
      20,    21,    22,    26,    25,     7,    17,    21,     8,     9,
      23,    24,     9,    24
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 61 "blif_parser.y"
    {;}
    break;

  case 3:
#line 64 "blif_parser.y"
    {;}
    break;

  case 4:
#line 65 "blif_parser.y"
    {;}
    break;

  case 5:
#line 69 "blif_parser.y"
    {
				/* Now create a module structure and store all data you just read into it. */
				t_temp_list *list = (t_temp_list *) (yyvsp[(4) - (5)].value);
				blif_circuit->name = (char *) (yyvsp[(1) - (5)].string);
...
#line 80 "blif_parser.y"
  ...
  case 9:
#line 89 "blif_parser.y"
    {;}
    break;

  case 10:
#line 91 "blif_parser.y"
    {
							/* Add signals to the set of primary inputs. */
							t_temp_list *list = (t_temp_list *) (yyvsp[(2) - (2)].value);
  ...
  case 11:
#line 112 "blif_parser.y"
    {;}
    break;

  case 12:
#line 114 "blif_parser.y"
    {
  ...
  case 13:
#line 138 "blif_parser.y"
    {
						t_temp_list *list = (t_temp_list *) (yyvsp[(1) - (2)].value);
						t_blif_cubical_function *func = (t_blif_cubical_function *) (yyvsp[(2) - (2)].value);

						list->count =
							append_array_element((int) func,
												 (int **) &(list->contents),
												 list->count);
						(yyval.value) = (int) list;
					;}
    break;

  case 14:
#line 149 "blif_parser.y"
    {
						t_blif_cubical_function *func = (t_blif_cubical_function *) (yyvsp[(1) - (1)].value);
  ...
  case 15:
#line 162 "blif_parser.y"
    {
						(yyval.value) = (int) NULL;
					;}
    break;

  case 16:
#line 168 "blif_parser.y"
    {
							t_blif_cubical_function *function = (t_blif_cubical_function *) (yyvsp[(1) - (2)].value);
							t_temp_cube_list *list = (t_temp_cube_list *) (yyvsp[(2) - (2)].value);
							...
							printf("Cubes: %i\n", function->cube_count);
						#endif
							(yyval.value) = (int) function;
						;}
    break;

  case 17:
#line 228 "blif_parser.y"
    {
...
#line 310 "blif_parser.y"
  ...
  case 20:
#line 314 "blif_parser.y"
    {
							t_temp_cube_list *list = (t_temp_cube_list *) (yyvsp[(1) - (2)].value);
							t_temp_cube_list *new_cube = (t_temp_cube_list *) (yyvsp[(2) - (2)].value);
  ...
  case 21:
#line 335 "blif_parser.y"
    {
						t_temp_cube_list *cube_list = (t_temp_cube_list *) malloc(sizeof(t_temp_cube_list));
						char *cube_string = (char *) (yyvsp[(1) - (2)].string);
						int cube_value = (int) (yyvsp[(2) - (2)].value);
						...
						(yyval.value) = (int) cube_list;
					;}
    break;

  case 22:
#line 379 "blif_parser.y"
    {
						/* A constant function */
						t_temp_cube_list *cube_list = (t_temp_cube_list *) malloc(sizeof(t_temp_cube_list));
						...
						cube_list->cube_list = NULL;
						cube_list->cube_count = 0;
						if (((yyvsp[(1) - (1)].value) == LITERAL_1) || ((yyvsp[(1) - (1)].value) == LITERAL_DC))
						{
							t_blif_cube *cube = (t_blif_cube *) malloc(sizeof(t_blif_cube));

							memset(cube, 0, sizeof(t_blif_cube));
							cube->data_size = 0;
							cube->is_DC = (((yyvsp[(1) - (1)].value) == LITERAL_1) ? T_FALSE : T_TRUE);
  ...
  case 23:
#line 404 "blif_parser.y"
    {
					t_blif_signal *logic_signal = (t_blif_signal *) (yyvsp[(1) - (1)].value);
					t_temp_list *list = (t_temp_list *) malloc(sizeof(t_temp_list));
  ...
  case 24:
#line 419 "blif_parser.y"
    {
					t_blif_signal *logic_signal = (t_blif_signal *) (yyvsp[(2) - (2)].value);
					t_temp_list *list = (t_temp_list *) (yyvsp[(1) - (2)].value);
  ...
  case 25:
#line 431 "blif_parser.y"
    {
					t_blif_signal *logic_signal = (t_blif_signal *) (yyvsp[(3) - (3)].value);
					t_temp_list *list = (t_temp_list *) (yyvsp[(1) - (3)].value);
  ...
  case 26:
#line 445 "blif_parser.y"
    {
				t_blif_signal *logic_signal = (t_blif_signal *) malloc(sizeof(t_blif_signal));
				
				assert(logic_signal != NULL);
				
				logic_signal->data.name = (yyvsp[(1) - (1)].string);
				(yyval.value) = (int) logic_signal;
			;}
    break;


/* Line 1267 of yacc.c.  */
#line 1811 "blif_parser.tab.c"
      default: break;
    }
